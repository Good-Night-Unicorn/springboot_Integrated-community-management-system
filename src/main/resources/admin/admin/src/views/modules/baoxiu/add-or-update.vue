               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报修名称" prop="baoxiuName">
                       <el-input v-model="ruleForm.baoxiuName"
                                 placeholder="报修名称" clearable  :readonly="ro.baoxiuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.baoxiuPhoto" label="报修图片" prop="baoxiuPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.baoxiuPhoto?$base.url+ruleForm.baoxiuPhoto:''"
                            @change="baoxiuPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="报修类型" prop="baoxiuTypes">
                        <el-select v-model="ruleForm.baoxiuTypes" :disabled="ro.baoxiuTypes" placeholder="请选择报修类型">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="报修状态" prop="baoxiuZhuangtaiTypes">
                        <el-select v-model="ruleForm.baoxiuZhuangtaiTypes" :disabled="ro.baoxiuZhuangtaiTypes" placeholder="请选择报修状态">
                            <el-option
                                v-for="(item,index) in baoxiuZhuangtaiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="报修详情" prop="baoxiuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.baoxiuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.baoxiuContent" label="报修详情" prop="baoxiuContent">
                            <span v-html="ruleForm.baoxiuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   insertTime: [
                              { required: true, message: '申请报修时间不能为空', trigger: 'blur' },
                          ],
                   baoxiuZhuangtaiTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=baoxiu_zhuangtai_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.baoxiuZhuangtaiTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.baoxiuContent = _this.ruleForm.baoxiuContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.baoxiuContent = this.ruleForm.baoxiuContent.replaceAll(this.$base.url,"");
                        this.$http({
            ...
            //图片
            baoxiuPhotoUploadChange(fileUrls){
                this.ruleForm.baoxiuPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
