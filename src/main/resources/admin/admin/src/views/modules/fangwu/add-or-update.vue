    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="房屋楼号" prop="fangwuLouhaoTypes">
                        <el-select v-model="ruleForm.fangwuLouhaoTypes" :disabled="ro.fangwuLouhaoTypes" placeholder="请选择房屋楼号">
                            <el-option
                                v-for="(item,index) in fangwuLouhaoTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="房屋楼号" prop="fangwuLouhaoValue">
                        <el-input v-model="ruleForm.fangwuLouhaoValue"
                            placeholder="房屋楼号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="单元号" prop="fangwuDanyuanTypes">
                        <el-select v-model="ruleForm.fangwuDanyuanTypes" :disabled="ro.fangwuDanyuanTypes" placeholder="请选择单元号">
                            <el-option
                                v-for="(item,index) in fangwuDanyuanTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="单元号" prop="fangwuDanyuanValue">
                        <el-input v-model="ruleForm.fangwuDanyuanValue"
                            placeholder="单元号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="房间号" prop="fangwuFanghao">
                       <el-input v-model="ruleForm.fangwuFanghao"
                                 placeholder="房间号" clearable  :readonly="ro.fangwuFanghao"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="房间号" prop="fangwuFanghao">
                           <el-input v-model="ruleForm.fangwuFanghao"
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    fangwuLouhaoTypes: false,
                    fangwuDanyuanTypes: false,
                    fangwuFanghao: false,
                    fangwuDelete: false,
                    insertTime: false,
                },
                ...
                fangwuLouhaoTypesOptions : [],
                fangwuDanyuanTypesOptions : [],
                yonghuOptions : [],
                rules: {
                   yonghuId: [
                   ...
                   fangwuLouhaoTypes: [
                              { required: true, message: '房屋楼号不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=fangwu_louhao_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.fangwuLouhaoTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=fangwu_danyuan_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.fangwuDanyuanTypesOptions = data.data.list;
                    }
                });
