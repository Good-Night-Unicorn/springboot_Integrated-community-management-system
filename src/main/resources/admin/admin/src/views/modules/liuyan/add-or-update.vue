    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="投诉标题" prop="liuyanName">
                       <el-input v-model="ruleForm.liuyanName"
                                 placeholder="投诉标题" clearable  :readonly="ro.liuyanName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="投诉标题" prop="liuyanName">
                           <el-input v-model="ruleForm.liuyanName"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="投诉内容" prop="liuyanText">
                        <el-input type="textarea"  :readonly="ro.liuyanText" v-model="ruleForm.liuyanText" placeholder="投诉内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.liuyanText" label="投诉内容" prop="liuyanText">
