    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="缴费" prop="feiyongName">
                       <el-input v-model="ruleForm.feiyongName"
                                 placeholder="缴费" clearable  :readonly="ro.feiyongName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="缴费" prop="feiyongName">
                           <el-input v-model="ruleForm.feiyongName"
                                     placeholder="缴费" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="缴费类型" prop="feiyongTypes">
                        <el-select v-model="ruleForm.feiyongTypes" :disabled="ro.feiyongTypes" placeholder="请选择缴费类型">
                            <el-option
                                v-for="(item,index) in feiyongTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="缴费类型" prop="feiyongValue">
                        <el-input v-model="ruleForm.feiyongValue"
                            placeholder="缴费类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="缴费状态" prop="feiyongZhuangtaiTypes">
                        <el-select v-model="ruleForm.feiyongZhuangtaiTypes" :disabled="ro.feiyongZhuangtaiTypes" placeholder="请选择缴费状态">
                            <el-option
                                v-for="(item,index) in feiyongZhuangtaiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="缴费状态" prop="feiyongZhuangtaiValue">
                        <el-input v-model="ruleForm.feiyongZhuangtaiValue"
                            placeholder="缴费状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="年月" prop="feiyongTime">
                        <el-date-picker
                                value-format="yyyy-MM"
                                v-model="ruleForm.feiyongTime"
                                type="month"
                                placeholder="年月"
                                :disabled="ro.feiyongTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.feiyongTime" label="年月" prop="feiyongTime">
                            <span v-html="ruleForm.feiyongTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="缴费金额" prop="feiyongOldMoney">
                       <el-input v-model="ruleForm.feiyongOldMoney"
                                 placeholder="缴费金额" clearable  :readonly="ro.feiyongOldMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="缴费金额" prop="feiyongOldMoney">
                           <el-input v-model="ruleForm.feiyongOldMoney"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   feiyongName: [
                              { required: true, message: '缴费不能为空', trigger: 'blur' },
                          ],
                   feiyongTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=feiyong_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.feiyongTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=feiyong_zhuangtai_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.feiyongZhuangtaiTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`feiyong/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.feiyongCrossAddOrUpdateFlag = false;
                                        this.parent.search();
