<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="缴费类型编码" prop="codeIndex">
                        <el-input v-model="ruleForm.codeIndex"
                                  placeholder="缴费类型编码" clearable  :readonly="ro.codeIndex"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="缴费类型编码" prop="codeIndex">
                            <el-input v-model="ruleForm.codeIndex"
                                      placeholder="缴费类型编码" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="缴费类型" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="缴费类型" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="缴费类型" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
        ...
        methods: {
            ...
            onSubmit() {
                if((!this.ruleForm.indexName)){
                    this.$message.error('缴费类型不能为空');
                    return
                }
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        let ruleForm = this.ruleForm;
                        ruleForm["dicCode"]="feiyong_types";
                        ruleForm["dicName"]="缴费类型";
                        this.$http({
