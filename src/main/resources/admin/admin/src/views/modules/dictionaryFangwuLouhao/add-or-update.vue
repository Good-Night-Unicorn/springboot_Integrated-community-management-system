<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="楼号编码" prop="codeIndex">
                        <el-input v-model="ruleForm.codeIndex"
                                  placeholder="楼号编码" clearable  :readonly="ro.codeIndex"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="楼号编码" prop="codeIndex">
                            <el-input v-model="ruleForm.codeIndex"
                                      placeholder="楼号编码" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="楼号" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="楼号" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="楼号" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    this.$http({
                        ...
                        method: "post",
                        data: {"dicCode":"fangwu_louhao_types"}
                    }).then(({ data }) => {
                        if (data && data.code === 0) {
            ...
            onSubmit() {
                if((!this.ruleForm.indexName)){
                    this.$message.error('楼号不能为空');
                    return
                }
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        let ruleForm = this.ruleForm;
                        ruleForm["dicCode"]="fangwu_louhao_types";
                        ruleForm["dicName"]="楼号";
                        this.$http({
