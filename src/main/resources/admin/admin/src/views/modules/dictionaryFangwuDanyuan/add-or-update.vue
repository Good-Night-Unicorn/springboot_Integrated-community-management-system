<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="单元编码" prop="codeIndex">
                        <el-input v-model="ruleForm.codeIndex"
                                  placeholder="单元编码" clearable  :readonly="ro.codeIndex"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="单元编码" prop="codeIndex">
                            <el-input v-model="ruleForm.codeIndex"
                                      placeholder="单元编码" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="单元" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="单元" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="单元" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    this.$http({
                        ...
                        method: "post",
                        data: {"dicCode":"fangwu_danyuan_types"}
                    }).then(({ data }) => {
                        if (data && data.code === 0) {
            ...
            onSubmit() {
                ...
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        ...
                        ruleForm["dicCode"]="fangwu_danyuan_types";
                        ruleForm["dicName"]="单元";
                        this.$http({
