    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="留言标题" prop="sixinName">
                       <el-input v-model="ruleForm.sixinName"
                                 placeholder="留言标题" clearable  :readonly="ro.sixinName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="留言标题" prop="sixinName">
                           <el-input v-model="ruleForm.sixinName"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="sixinText">
                        <el-input type="textarea"  :readonly="ro.sixinText" v-model="ruleForm.sixinText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.sixinText" label="留言内容" prop="sixinText">
                            <span v-html="ruleForm.sixinText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`sixin/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.sixinCrossAddOrUpdateFlag = false;
                                        this.parent.search();
