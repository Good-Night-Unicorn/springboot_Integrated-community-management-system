<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='wuye'"  label='物业人员姓名' prop="wuyeName">
               <el-input v-model="ruleForm.wuyeName"  placeholder='物业人员姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='wuye'"  label='物业人员手机号' prop="wuyePhone">
               <el-input v-model="ruleForm.wuyePhone"  placeholder='物业人员手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='wuye'"  label='物业人员身份证号' prop="wuyeIdNumber">
               <el-input v-model="ruleForm.wuyeIdNumber"  placeholder='物业人员身份证号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='wuye'" label='物业人员头像' prop="wuyePhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='wuye'"  label='人员类型' prop="wuyeTypes">
                 <el-select v-model="ruleForm.wuyeTypes"  placeholder='请选择人员类型'>
                     <el-option
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='wuye'"  label='物业人员邮箱' prop="wuyeEmail">
               <el-input v-model="ruleForm.wuyeEmail"  placeholder='物业人员邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
...
|| flag=='wuye')"  label="性别" prop="sexTypes">
...
// 注册表 物业人员 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.wuyeName)&& 'wuye'==this.flag){
                             this.$message.error('物业人员姓名不能为空');
                             return
                         }

                             if( 'wuye' ==this.flag && this.ruleForm.wuyePhone&&(!isMobile(this.ruleForm.wuyePhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.wuyeIdNumber)&& 'wuye'==this.flag){
                             this.$message.error('物业人员身份证号不能为空');
                             return
                         }

                         if((!this.ruleForm.wuyePhoto)&& 'wuye'==this.flag){
                             this.$message.error('物业人员头像不能为空');
                             return
                         }

                         if((!this.ruleForm.wuyeTypes)&& 'wuye'==this.flag){
                             this.$message.error('人员类型不能为空');
                             return
                         }

                             if( 'wuye' ==this.flag && this.ruleForm.wuyeEmail&&(!isEmail(this.ruleForm.wuyeEmail))){
