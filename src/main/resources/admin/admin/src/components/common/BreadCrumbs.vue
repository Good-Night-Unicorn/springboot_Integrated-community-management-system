<template>
  <el-breadcrumb class="app-breadcrumb" separator="/"style="height:50px;backgroundColor:var(--publicMainColor);borderRadius:0;padding:0px 20px 0px 20px;boxShadow:0px 0px 0px #f903d4;borderWidth:0;borderStyle:dotted solid double dashed;borderColor:#ff0000;">
    ...
    breadcrumbStyleChange(val) {
      this.$nextTick(()=>{
        ...
        document.querySelectorAll('.app-breadcrumb .el-breadcrumb__inner a').forEach(el=>{
          el.style.color = "rgba(116, 116, 116, 1)"
        })
